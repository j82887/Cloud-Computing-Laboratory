...
| 5 | 3/24 | 車牌辨識：資料集合併 | 深度學習：多層感知器與卷積神經網路 | -- |
| 6 | 3/31 | 車牌辨識：資料前處理 | 分類模型的驗證指標 | -- |
| 7 | 4/07 | 車牌辨識：CNN分類器 | 資料前處理-不均勻類別 | -- |
| 8 | 4/14 | 車牌辨識：實際應用 | 資料前處理-特徵縮放與獨熱編碼 | -- |
| 9 | 4/21 | 人臉辨識模型應用 | 超參數搜索 | -- |
| 10 | 4/28 | 表情辨識模型應用 | 目標檢測模型與驗證指標 | 期中週 |
